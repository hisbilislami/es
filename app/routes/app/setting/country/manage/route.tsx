...
import { countryFormLabel, schema } from "./constant";
...
const CountryForm = () => {
  ...
  const [form, fields] = useForm({
    ...
    defaultValue: {
      ...
      active: country ? (country.active ? "y" : "n") : "y",
    },
  });
  ...
  return (
    <>
      <Form
        method="POST"
        {...getFormProps(form)}
        action="/app/setting/country/manage"
      >
        <AppCardForm
          isForm={true}
          ...
          actionButtons={
            <div className="inline-flex gap-3">
              <Button
                ...
                variant="default"
                onClick={() => navigate("/app/setting/country")}
        ...
        >
          <div className="grid grid-cols-2">
            <div className="p-5">
              ...
              <InputText
                fields={fields}
                {...countryFormLabel["code"]}
                my="sm"
              />
              <InputText
                fields={fields}
                {...countryFormLabel["name"]}
                my="sm"
              />
              <InputText
                fields={fields}
                {...countryFormLabel["iso_code"]}
                my="sm"
              />
            </div>
            <div className="p-5">
              <InputText
                fields={fields}
                {...countryFormLabel["iso_name"]}
                my="sm"
              />
              <InputText
                fields={fields}
                {...countryFormLabel["phone_code"]}
                max="4"
                my="sm"
              />
              <InputRadio
